...
import 'jenis_aksesoris_controller.dart';

class JenisAksesorisPage extends StatefulWidget {
  const JenisAksesorisPage({super.key});

  @override
  State<JenisAksesorisPage> createState() => _JenisAksesorisPageState();
}

class _JenisAksesorisPageState extends State<JenisAksesorisPage> {
  final controller = Get.put(JenisAksesorisController());
