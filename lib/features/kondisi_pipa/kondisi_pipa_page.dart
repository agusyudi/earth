...
import 'kondisi_pipa_controller.dart';

class KondisiPipaPage extends StatefulWidget {
  const KondisiPipaPage({super.key});

  @override
  State<KondisiPipaPage> createState() => _KondisiPipaPageState();
}

class _KondisiPipaPageState extends State<KondisiPipaPage> {
  final controller = Get.put(KondisiPipaController());
