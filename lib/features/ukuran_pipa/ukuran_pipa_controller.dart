...
import '../../models/ukuran_pipa_model.dart';
import '../../models/pipa_model.dart';
import '../../services/rest_api_client_service.dart';

class UkuranPipaController extends GetxController {
  var list = <UkuranPipaModel>[].obs;
  var selectedList = <UkuranPipaModel>[].obs;
    ...
    try {
      ...
      if (apiResponse.status == true) {
        for (var i in apiResponse.data) {
          var jsonRes = UkuranPipaModel.fromJson(i);
          list.add(jsonRes);
        }
