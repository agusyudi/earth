...
import 'ukuran_pipa_controller.dart';

class UkuranPipaPage extends StatefulWidget {
  const UkuranPipaPage({super.key});

  @override
  State<UkuranPipaPage> createState() => _UkuranPipaPageState();
}

class _UkuranPipaPageState extends State<UkuranPipaPage> {
  final controller = Get.put(UkuranPipaController());
